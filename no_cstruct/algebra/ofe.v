From myiris.prelude Require Export prelude.
...
Elpi Accumulate TC.Solver lp:{{
  ...
  :after "0" tc-myiris.algebra.ofe.tc-Dist _ {{ofe_dist _}}.
}}.
...
Section sigT.
  ...
  *)
  ...
  Proof.
    ...
    exists eq_refl => /=. 
    (* TODO: @FissoreD here added simpl to correctly find proof *)
    (* simpl in *. *)
    apply equiv_dist, (discrete_0 _), Hxy.
  Qed.
