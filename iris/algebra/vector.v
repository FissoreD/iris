...
Section ofe.
  ...
  Proof.
    ...
    - intros n Hn c. by rewrite (conv_lbcompl n Hn (bchain_map _ c) zero (proper_limit_not_zero Hn)) /= vec_to_list_length.
  Qed.
...
Qed.
Global Instance vec_map_ne `{SI : indexT} {A B : ofe} m f n :
...
Global Instance vecOF_contractive `{SI : indexT} F m :
