...
Local Definition big_opM_def `{SI : indexT} {M : ofe} {o : M → M → M}  `{!Monoid o} `{Countable K} {A} (f : K → A → M)
...
Local Definition big_opS_def `{SI : indexT} {M : ofe} {o : M → M → M} `{!Monoid o} `{Countable A} (f : A → M)
...
Local Definition big_opMS_def `{SI : indexT} {M : ofe} {o : M → M → M} `{!Monoid o} `{Countable A} (f : A → M)
