...
(** Option *)
Lemma big_opL_None `{SI : indexT} {M : cmra} {A} (f : nat → A → option M) l :
...
Qed.
Lemma big_opM_None `{SI : indexT} {M : cmra} `{Countable K} {A} (f : K → A → option M) m :
...
Qed.
Lemma big_opS_None `{SI : indexT} {M : cmra} `{Countable A} (f : A → option M) X :
...
Qed.
Lemma big_opMS_None `{SI : indexT} {M : cmra} `{Countable A} (f : A → option M) X :
