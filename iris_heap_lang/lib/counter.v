...
Section mono_proof.
  ...
  Lemma read_mono_spec l j :
    {{{ mcounter l j }}} read #l {{{ i, RET #(Z.of_nat i); ⌜j ≤ i⌝ ∧ mcounter l i }}}.
  Proof.
...
Section contrib_spec.
  ...
  Lemma read_contrib_spec γ l q n :
    ...
    {{{ c, RET #(Z.of_nat c); ⌜n ≤ c⌝ ∧ ccounter γ q n }}}.
  Proof.
    iIntros (Φ) "[#? Hγf] HΦ".
