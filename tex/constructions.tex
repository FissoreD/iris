...
\begin{align*}
  ...
  \latertinj(x) \equivN{n} \latertinj(y) \eqdef{}& n = 0 \lor x \equivN{n-1} y
\end{align*}
...
{\All n, \melt, \meltB. \melt \mincl[n] \meltB \Ra \pred(\melt) \inclN{n} \pred(\meltB)} \\
  ...
  \pred \equivN{n} \predB \eqdef{}& \All m \le n, \melt. m \in \mval(\melt) \Ra (m \in \pred(\melt) \iff  m \in \predB(\melt))
\end{align*}
...
\begin{align*}
  \All n, \melt.  (\mval(\melt) \inclN{n} P_0(\melt)) \Ra n \in P_0(\melt)  \tagH{UPred-canonical}
\end{align*}
...
\begin{mathpar}
  \infer{x \equivN{n} y}{\cinl(x) \equivN{n} \cinl(y)}

  \infer{x \equivN{n} y}{\cinr(x) \equivN{n} \cinr(y)}

  \axiom{\mundef \equivN{n} \mundef}
\end{mathpar}
...
\begin{align*}
  ...
  \melt \equivN{n} \meltB \eqdef{}& (\All x \in \melt. \Exists y \in \meltB. x \equivN{n} y) \land (\All y \in \meltB. \Exists x \in \melt. x \equivN{n} y) \\
  \textnormal{where }& \melt \sim \meltB \eqdef{} \All n. \melt \equivN{n} \meltB  \\
~\\
%    \All n \in {\melt.V}.\, \melt.x \equivN{n} \meltB.x \\
  \mval(\melt) \eqdef{}& \setComp{n}{ \All x, y \in \melt. x \equivN{n} y } \\
...
\begin{mathpar}
  ...
  \axiomH{ag-agree}{n \in \mval(\aginj(x) \mtimes \aginj(y)) \Ra x \equivN{n} y}
\end{mathpar}
...
The step-indexed equivalence is inductively defined as follows:
\begin{mathpar}
  \infer{x \equivN{n} y}{\exinj(x) \equivN{n} \exinj(y)}
...
\mval( (x, \meltB ) ) \eqdef{}& \setComp{ n }{ (x = \mnocore \land n \in \mval(\meltB)) \lor (\Exists \melt. x = \exinj(\melt) \land \meltB \mincl_n \melt \land n \in \mval(\melt)) } \\
  ...
  (x_1, \meltB_1) \equivN{n} (x_2, \meltB_2) \eqdef{}& x_1 \equivN{n} x_2 \land \meltB_1 \equivN{n} \meltB_2
\end{align*}
...
\begin{defn}
  ...
  \[ \All n, \maybe{\melt_\f}. n \in \mval(\melt_1) \land \melt_1 \equivN{n} \meltB_1 \mtimes \maybe{\melt_\f} \Ra n \in \mval(\melt_2) \land \melt_2 \equivN{n} \meltB_2 \mtimes \maybe{\melt_\f} \]
\end{defn}
